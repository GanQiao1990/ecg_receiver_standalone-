...
python -m pip install kivy^>=2.3.0 psutil^>=5.9.0
...
python -c "import kivy, numpy, serial, requests, psutil; print('✅ All core modules imported successfully')" || (
...
REM Kivy GUI shortcut
echo @echo off > "%DESKTOP%\ECG Kivy GUI.bat"
echo cd /d "%CURRENT_DIR%" >> "%DESKTOP%\ECG Kivy GUI.bat"
echo python launch_kivy_gui.py >> "%DESKTOP%\ECG Kivy GUI.bat"
echo pause >> "%DESKTOP%\ECG Kivy GUI.bat"
...
echo    Option 1: Double-click "ECG Kivy GUI" on Desktop
echo    Option 2: Double-click "ECG Legacy GUI" on Desktop  
echo    Option 3: Run "python launch_kivy_gui.py" in this folder
echo.
echo ⚙️  Next steps:
